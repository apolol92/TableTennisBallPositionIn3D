...
# Just a little script which measures the distance between webcam and a table tennis ball.
...
# This function will give you the ball data in current image
